...
let familyAnnualQuote = 0; 
    ...
    for (let i =0; i <family.length; i++) {
        ...
        console.log('\tMonthlyPremium for ' + familyMember.name + ": $" + month);

        // Add the monthly premium * 12 to the total annual premium
        familyAnnualQuote += month *12; 
    }
    // Print the total to the console
    console.log('');  //Print a blank line
    console.log('TOTAL annual premium: $' + familyAnnualQuote);
    return familyAnnualQuote;
}
